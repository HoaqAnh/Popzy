...
import com.propzy.propzy.util.RequestUtil;
import com.propzy.propzy.util.SecurityUtil;
import com.propzy.propzy.util.exception.IdInvalidException;
...
public class AuthController {
    ...
    @Value("${ducthien.jwt.refresh-token-validity-in-seconds:90000}")
